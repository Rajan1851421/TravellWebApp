        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300 h-full flex flex-col">
          ...
          <div className="p-5 flex flex-col flex-grow">
            ...
            <div className="mt-auto">
              ...
              <button className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-medium py-2.5 px-4 rounded-lg hover:from-blue-700 hover:to-cyan-600 transition-all duration-300 shadow-sm">
                Book Now
              </button>
            </div>
          </div>
